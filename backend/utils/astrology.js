...
const astrologyDescriptions = {
  sun: {
    signs: {
      ...
      Cancer: "Je kernverlangen is veiligheid, verbondenheid en emotionele diepgang. Je zorgt graag voor anderen, maar kunt jezelf verliezen in hun behoeften. Je groeit als je jezelf ook thuis leert voelen binnenin.\n🔑 Trigger: Kun jij je hart openen zonder jezelf weg te cijferen?",
      ...
      Libra: "Harmonie, schoonheid en balans vormen jouw kern. Je voelt je op je best in verbinding met anderen, maar kunt jezelf verliezen in please-gedrag. Je leert dat ware harmonie van binnen begint.\n🔑 Trigger: Kun jij jezelf trouw blijven, ook als dat tot conflict leidt?",
      ...
      Sagittarius: "Je leeft voor groei, avontuur en waarheid. Je bent optimistisch, filosofisch en zoekt altijd de grotere betekenis. Maar je kunt jezelf verliezen in ideeën zonder grounding.\n🔑 Trigger: Kun jij jouw vrijheid vinden binnen grenzen?",
    ...
    houses: {
      ...
      4: "Zon in het 4e huis – De stille kracht achter gesloten deuren\nJe kracht ligt in je wortels, je gezin, je gevoel van thuis. Je bent geen roeper – jouw licht schijnt van binnenuit. Toch kan het voelen alsof niemand ziet wie je echt bent, behalve in je veilige cocon. Deze plaatsing vraagt je: durf je je binnenwereld ook zichtbaar te maken? Psychologische trigger: Kun je jezelf zijn, ook buiten de veilige muren die je om je heen hebt gebouwd?",
